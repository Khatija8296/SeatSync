...
// const { Passenger } = require('../db/passenger');
// const { sequelize } = require('../db/dbConnectionsModel');
// const { Count } = require('../db/CountModel'); // Import Count model
...
//     // Update count for the bus
//     const count = await Count.findOne({ where: { busId: bookingData.busId } });
//     if (count) {
//       count.counts += 1; // Increment count for bookings
